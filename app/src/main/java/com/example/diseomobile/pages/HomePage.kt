...
fun HomePage() {
    Column(
        ...
        Row ( modifier = Modifier.fillMaxWidth()){
            Text(text = stringResource(R.string.WelcomMessage) + "Gonzalo Mato!", style = Title2Regular)
        }
        Spacer(modifier = Modifier.padding(12.dp))
        BalanceCard(balance = "$ 25.000", negative = false)
        Spacer(modifier = Modifier.padding(12.dp))
        OutlineButton(text = stringResource(id = R.string.AddFunds ) , type = ButtonType.PRIMARY ) {
